...
fragColour [0] = texture2D (diffuseTex , IN.texCoord );  //texture colours
fragColour [1] = vec4( normal.xyz * 0.5 + 0.5 ,1.0);   //to get in range of 0 to 1 //tbn transformed normals
}