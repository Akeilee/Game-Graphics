...
Mesh* Mesh::GenerateTriangle() {
	...
	n->vertices[0] = Vector3(0.0f, 0.2f, 0.0f);
	n->vertices[1] = Vector3(0.2f, -0.2f, 0.0f);
	n->vertices[2] = Vector3(-0.2f, -0.2f, 0.0f);

	n->colours = new Vector4[n->numVertices];
	n->colours[0] = Vector4(1.0f, 0.0f, 0.0f, 1.0f);
	n->colours[1] = Vector4(0.0f, 1.0f, 0.0f, 1.0f);
	n->colours[2] = Vector4(0.0f, 0.0f, 1.0f, 1.0f);

	//tut 3
	n->textureCoords = new Vector2[n->numVertices];
	n->textureCoords[0] = Vector2(0.5f, 0.0f);
	n->textureCoords[1] = Vector2(1.0f, 1.0f);
	n->textureCoords[2] = Vector2(0.0f, 1.0f);
